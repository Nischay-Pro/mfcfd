...
!   with respect to varying inputs: gxp u1 u2 pr rho
  SUBROUTINE FLUX_GXP_D(gxp, gxpd, nx, ny, u1, u1d, u2, u2d, rho, rhod, pr, prd)
    IMPLICIT NONE
...
!   with respect to varying inputs: gxn u1 u2 pr rho
  SUBROUTINE FLUX_GXN_D(gxn, gxnd, nx, ny, u1, u1d, u2, u2d, rho, rhod, pr, prd)
    IMPLICIT NONE
...
!   with respect to varying inputs: gyp u1 u2 pr rho
  SUBROUTINE FLUX_GYP_D(gyp, gypd, nx, ny, u1, u1d, u2, u2d, rho, rhod, pr, prd)
    IMPLICIT NONE
...
!   with respect to varying inputs: gyn u1 u2 pr rho
  SUBROUTINE FLUX_GYN_D(gyn, gynd, nx, ny, u1, u1d, u2, u2d, rho, rhod, pr, prd)
    IMPLICIT NONE
